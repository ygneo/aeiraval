...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attendance.reportedType'
        db.alter_column(u'aeiraval_app_attendance', 'reportedType', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):

        # Changing field 'Attendance.reportedType'
        db.alter_column(u'aeiraval_app_attendance', 'reportedType', self.gf('django.db.models.fields.IntegerField')())
