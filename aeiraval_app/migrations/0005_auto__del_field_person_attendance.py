...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Person.attendance'
        raise RuntimeError("Cannot reverse this migration. 'Person.attendance' and its values cannot be restored.")
